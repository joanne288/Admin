    ...
    emailsData: [
        {
            ...
            avatar: "https://images.unsplash.com/photo-1494790108755-2616b612b786?ixlib=rb-4.0.3&auto=format&fit=crop&w=40&h=40",
        },
        {
            id: 2,
            name: "Kristin Watson",
...
function generateCalendar() {
    ...
    calendarBody.innerHTML = calendarDays
        .map((day) => {
            ...
            return `<div class="calendar-day ${isSelected ? "selected" : ""}" data-day="${day}">${day}</div>`;
        })
        .join("");
}
